...
<?php  if (isset($_POST['new'])) {
  ...
  $query = "INSERT INTO feedback (username) 
  VALUES('$username')";
    ...
    <div class="container">
        ...
        <form role="form" action="feedback.php" method="POST">
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="RATE" name="title" required>
            </div>
            <div class="form-group">
                <textarea class="form-control" rows="5" placeholder="HOW CAN WE IMPROVE 🤔 🤔 ? DID U FIND ANY BUGS  🤷??" name="content" autofocus required></textarea>
            </div>
            <div class="btn-group float-right">
                <button class="btn btn-danger" type="reset"><span class="fa fa-times mr-2"></span>Clear</button>
                <button class="btn btn-success" name="new" type="submit"><span class="fa fa-paper-plane mr-2"></span>SUBMIT</button>
            </div>
        </form>
    </div>
